...
PERSONAL_TABLEAU_USER = os.getenv('PERSONAL_TABLEAU_USER')
PERSONAL_TABLEAU_PASSWORD = os.getenv('PERSONAL_TABLEAU_PASSWORD')

TABLEAU_SERVER = "https://dub01.online.tableau.com"
TABLEAU_SITE_ID = "AlphaIT-Daniel"
TABLEAU_USER = PERSONAL_TABLEAU_USER
TABLEAU_PASSWORD = PERSONAL_TABLEAU_PASSWORD
...
def main():
    ...
    server = TSC.Server(server_address=TABLEAU_SERVER)
